      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <div className='md:col-span-2 grid grid-cols-2 gap-4'>
          <div className='bg-indigo-50 p-6 rounded-xl border border-indigo-100'>
            <p className='text-indigo-600 text-sm font-bold uppercase'>
              Total Classes
            </p>
            <p className='text-4xl font-bold text-indigo-900'>{stats.total}</p>
          </div>
          <div className='bg-green-50 p-6 rounded-xl border border-green-100'>
            <p className='text-green-600 text-sm font-bold uppercase'>
              Days Present
            </p>
          ...
          <div className='bg-red-50 p-6 rounded-xl border border-red-100 col-span-2'>
            <p className='text-red-600 text-sm font-bold uppercase'>
              Days Absent
            </p>
