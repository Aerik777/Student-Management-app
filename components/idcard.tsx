    ...
    <div className="flex flex-col items-center gap-4">
      ...
      >
        <div className="w-24 h-24 bg-gray-200 rounded-full mb-4 border-2 border-white overflow-hidden">
            ...
            <div className="flex items-center justify-center h-full text-gray-400">Photo</div>
        </div>
        
        <h2 className="text-xl font-bold uppercase tracking-wider">{student.name}</h2>
        <p className="text-indigo-200 text-sm mb-6">{student.department} Department</p>
